...
// // // import { NAV_SECTIONS, ADMIN_SECTION } from "./sidebarConfig";
...
// // //                 <button
// // //                   onClick={onClose}
// // //                   className="absolute right-2 top-2 z-10 grid size-8 cursor-pointer place-items-center rounded-md text-muted-foreground transition-colors hover:bg-sidebar-accent hover:text-sidebar-accent-foreground md:hidden"
// // //                 >
// // //                   <X size={18} />
// // //                 </button>
// // //               )}
...
// // //                 className="absolute right-2 top-2 z-10 hidden md:grid size-8 cursor-pointer place-items-center rounded-md text-muted-foreground transition-colors hover:bg-sidebar-accent hover:text-sidebar-accent-foreground"
// // //               >
// // //                 {collapsed ? (
// // //                   <PanelLeft size={18} />
// // //                 ) : (
...
// // // import { useState } from "react";
// // // import { useLocation, Link } from "react-router-dom"; // ← أضفنا Link
// // // import { PanelLeftClose, PanelLeft, X } from "lucide-react";
// // // import {
// // //   Sidebar,
// // //   SidebarProvider,
...
// // // import { SidebarSectionLabel, SidebarDivider } from "./SidebarSection";
// // // import { SidebarUser } from "./SidebarUser";
// // // import { USER_NAV_SECTIONS, ADMIN_NAV_SECTIONS } from "./sidebarConfig";
...
// // //   // ✅ نختار الـ sections بناءً على الـ role
// // //   const isAdmin = profile?.role === "admin";
// // //   const navSections = isAdmin ? ADMIN_NAV_SECTIONS : USER_NAV_SECTIONS;
...
// // //   SidebarMenu,
// // // } from "@/components/ui/sidebar";
// // // import { useProfile } from "@/features/profile/hooks/useProfile"; // ← استخدم useProfile
// // // import { SidebarNavLink } from "./SidebarNavLink";
// // // import { SidebarSectionLabel, SidebarDivider } from "./SidebarSection";
// // // import { SidebarUser } from "./SidebarUser";
// // // import { USER_NAV_SECTIONS, ADMIN_NAV_SECTIONS } from "./sidebarConfig";
...
// // // export default function AppSidebar({ onClose }) {
// // //   const [collapsed, setCollapsed] = useState(false);
// // //   const { profile, isLoading } = useProfile(); // ← useProfile بيجيب من profiles table
...
// // //   // ✅ نستخدم profile?.role من profiles table (مش auth.users)
// // //   const isAdmin = profile?.role === "admin";
// // //   const navSections = isAdmin ? ADMIN_NAV_SECTIONS : USER_NAV_SECTIONS;
...
// //   // ✅ نستخدم useProfile بس لو فيه user
...
import { SidebarSectionLabel, SidebarDivider } from "./SidebarSection";
import { SidebarUser } from "./SidebarUser";
import { USER_NAV_SECTIONS, ADMIN_EXTRA_SECTIONS } from "./sidebarConfig";
          ...
          >
            ...
            <SidebarContent className="gap-0! pt-2 overflow-x-hidden!">
              {authLoading || isProfileLoading ? (
                ...
                <>
                  {/* ✅ User Sections (للكل - User و Admin) */}
                  {USER_NAV_SECTIONS.map((section, i) => (
                    <div key={i}>
                      {section.label && (
                        <SidebarSectionLabel
